...
exports.addCommentByPostId = addCommentByPostId;
...
function getPosts() {
  return _superagent2.default.get('/v1/posts').then(function (res) {
    var posts = res.body;
    return posts;
  }).catch(function () {
...
function addPost(post) {
  ...
  return _superagent2.default.post('/v1/posts').send(post).then(function (res) {
    var returnedPost = res.body;
    return returnedPost;
  });
}
...
function updatePost(post, id) {
  post.id = id;
  post.paragraphs = post.paragraphs.split('\n');
  return _superagent2.default.put('/v1/posts/' + id).send(post).then(function (res) {
    var returnedPost = res.body;
    return returnedPost;
  });
}
...
function deletePost(postId) {
  return _superagent2.default.del('/v1/posts/' + postId).then(function (res) {
    var returnedPost = res.body;
    return returnedPost;
  });
}
...
function getCommentsByPostId(postId) {
  ...
  return _superagent2.default.get('/v1/posts/' + postId + '/comments').then(function (res) {
    var returnedComments = res.body;
    return returnedComments;
  });
}

function addCommentByPostId(postId, comment) {
  var comment2 = {
    id: postId,
    comment: comment.comment
  };
  return _superagent2.default.post('/v1/posts/' + postId + '/comments').send(comment2).then(function (res) {
    var returnedComment = res.body;
    return returnedComment;
  });
}

function updateComment(comment) {
  return _superagent2.default.put('/v1/comments/' + comment.location).send(comment).then(function (res) {
    var returnedComment = res.body;
    return returnedComment;
  });
}
...
function deleteComment(commentId) {
  return _superagent2.default.del('/v1/comments/' + commentId).then(function (res) {
    var returnedComment = res.body;
    return returnedComment;
  });
}
...
function likePost(commentId) {
  ...
  return _superagent2.default.put('/v1/posts/like/' + commentId).then(function (res) {
    // console.log(res);
...
function getLikes(commentId) {
  ...
  return _superagent2.default.get('/v1/posts/like/' + commentId).then(function (res) {
    console.log(res);
...
var _AppRoutes = __webpack_require__(/*! ./AppRoutes */ "./client/components/AppRoutes.jsx");

var _AppRoutes2 = _interopRequireDefault(_AppRoutes);

var _api = __webpack_require__(/*! ../api */ "./client/api/index.js");
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function fetchPosts() {
      ...
      return (0, _api.getPosts)().then(function (posts) {
...
var _Posts = __webpack_require__(/*! ./Posts */ "./client/components/Posts.jsx");

var _Posts2 = _interopRequireDefault(_Posts);

var _PostForm = __webpack_require__(/*! ./PostForm */ "./client/components/PostForm.jsx");
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', render: function render(props) {
              return _react2.default.createElement(_Posts2.default, _extends({
                posts: _this2.props.posts,
                fetchPosts: _this2.props.fetchPosts
              }, props));
            } }),
          _react2.default.createElement(_reactRouterDom.Route, { path: '/posts/new', render: function render(props) {
              return _react2.default.createElement(_PostForm2.default, _extends({
                fetchPosts: _this2.props.fetchPosts
              }, props));
            } }),
          _react2.default.createElement(_reactRouterDom.Route, { path: '/posts/edit/:id', render: function render(props) {
              return _react2.default.createElement(_PostForm2.default, _extends({
                fetchPosts: _this2.props.fetchPosts,
                post: _this2.props.posts.find(function (post) {
                  return post.id === Number(props.match.params.id);
                })
              }, props));
            } }),
          _react2.default.createElement(_reactRouterDom.Route, { path: '/posts/:id', render: function render(props) {
          ...
          _react2.default.createElement(_reactRouterDom.Route, { path: '/posts/:postId/comments/:commentId', render: function render(props) {
              return _react2.default.createElement(_Post2.default, _extends({
                post: _this2.props.posts.find(function (post) {
                  return post.id === Number(props.match.params.id);
                })
...
var _CommentForm = __webpack_require__(/*! ./CommentForm */ "./client/components/CommentForm.jsx");
...
var Comments = function (_React$Component) {
  ...
  _createClass(Comments, [{
    ...
    value: function deleteComment() {
      ...
      (0, _api.deleteComment)(this.props.comment.id).then(function () {
        return _this2.props.fetchComments(_this2.props.postId);
      });
    }
  }, {
    key: 'render',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_reactRouterDom.Route, {
            ...
            render: function render(props) {
              return _react2.default.createElement(_CommentForm2.default, _extends({
...
/***/ "./client/components/CommentForm.jsx":
/*!*******************************************!*\
  !*** ./client/components/CommentForm.jsx ***!
  \*******************************************/
/*! no static exports found */
  ...
  _createClass(CommentForm, [{
    ...
    value: function handleSubmit(e) {
      ...
      if (comment) {
        ...
        this.state = obj;
        (0, _api.updateComment)(this.state).then(function () {
          return fetchComments(_this2.props.postId);
        }).then(function () {
          history.push("/posts/" + _this2.state.location);
        }).catch(function (err) {
          return _this2.setState({ errorMessage: err.message });
        });
      } else {
        (0, _api.addCommentByPostId)(match.params.postId, this.state.comment).then(function () {
          return fetchComments(match.params.postId);
        }).then(function () {
          return history.push("/posts/" + match.params.postId);
        }).catch(function (err) {
          return _this2.setState({ errorMessage: err.message });
        });
      }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement("input", { className: "pure-button", type: "submit" }),
        _react2.default.createElement(
          "p",
          null,
...
var _Comment = __webpack_require__(/*! ./Comment */ "./client/components/Comment.jsx");
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _reactRouterDom.Link,
            { to: '/posts/new', className: 'pure-button' },
            'Add Post'
          )
        )
      )
...
var _Comments = __webpack_require__(/*! ./Comments */ "./client/components/Comments.jsx");
...
var Post = function (_React$Component) {
  ...
  _createClass(Post, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var id = this.props.post.id || this.props.match.params.id;
      if (id) {
    ...
    key: "fetchLikes",
    value: function fetchLikes(id) {
      var _this2 = this;

      console.log(id);
      (0, _api.getLikes)(id).then(function (data2) {

        _this2.setState({ likes: data2.data[0].likes });
      });
    }
  }, {
    key: "fetchComments",
    value: function fetchComments(postId) {
      var _this3 = this;

      (0, _api.getCommentsByPostId)(postId).then(function (comments) {
        return _this3.setState({ comments: comments });
      }).catch(function (err) {
    ...
    value: function deletePost() {
      ...
      (0, _api.deletePost)(this.props.post.id).then(this.props.fetchPosts).catch(function (err) {
        return _this4.setState({ errorMessage: err.message });
      });
    }
  }, {
    key: "likePost",
    value: function likePost() {
      ...
      (0, _api.likePost)(this.props.post.id).then(function (data) {
        (0, _api.getLikes)(_this5.props.post.id).then(function (data2) {

          // console.log(data2);
          // console.log('here');
          // console.log(data2.data[0].likes);

          _this5.setState({ likes: data2.data[0].likes });
        });
      })

      // this.setState({likes : data.data.likes})})
      .catch(function (err) {
        return _this5.setState({ errorMessage: err.message });
      });
    }
  }, {
    key: "render",
    value: function render() {
      var _props$post = this.props.post,
          ...
          paragraphs = _props$post.paragraphs,
          id = _props$post.id;

      var date = this.props.post.date_created;
      return _react2.default.createElement(
        "div",
        { className: "post" },
        _react2.default.createElement(
        ...
        paragraphs.map(function (para, key) {
          return _react2.default.createElement(
            "p",
            { key: key },
            para
        ...
        _react2.default.createElement(
          "div",
          { className: "pure-button-group", role: "group" },
          _react2.default.createElement(
            _reactRouterDom.Link,
            { to: "/posts/edit/" + id },
            _react2.default.createElement(
        ...
        this.props.path !== "/" && _react2.default.createElement(_Comments2.default, {
          postId: id,
...
/***/ "./client/components/PostForm.jsx":
/*!****************************************!*\
  !*** ./client/components/PostForm.jsx ***!
  \****************************************/
/*! no static exports found */
...
var PostForm = function (_React$Component) {
  ...
  _createClass(PostForm, [{
    ...
    key: "setNewPost",
    value: function setNewPost(post) {
      var paragraphs = {
    ...
    value: function handleSubmit(e) {
      ...
      if (post) {
        (0, _api.updatePost)(this.state.post, this.props.match.params.id).then(fetchPosts).then(navigateToPost(post.id)).catch(function (err) {
          return _this2.setState({ errorMessage: err.message });
        });
      } else {
        (0, _api.addPost)(this.state.post).then(function (newPost) {
          fetchPosts().then(navigateToPost(newPost.id));
        }).catch(function (err) {
          return _this2.setState({ errorMessage: err.message });
        });
      }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        this.props.post ? _react2.default.createElement(
          "h2",
          { className: "post-title" },
          "Edit Post"
        ) : _react2.default.createElement(
