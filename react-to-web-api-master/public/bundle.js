    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'a',
            { id: 'show-widget-link', href: '#',
              onClick: this.showAddWidget },
            'Add widget'
          )
        ),
...
var AddWidget = function (_React$Component) {
  _inherits(AddWidget, _React$Component);

  function AddWidget(props) {
    _classCallCheck(this, AddWidget);

    var _this = _possibleConstructorReturn(this, (AddWidget.__proto__ || Object.getPrototypeOf(AddWidget)).call(this, props));
  ...
  _createClass(AddWidget, [{
    ...
    value: function addWidget(e) {
      (0, _api.appendWidget)(this.state, this.props.finishAdd);
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { type: 'button', onClick: this.addWidget },
            'Add widget'
          ),
          ' ',
          _react2.default.createElement(
...
var _WidgetListItem = __webpack_require__(38);
...
exports.default = WidgetListItem;
...
var UpdateWidget = function (_React$Component) {
  ...
  _createClass(UpdateWidget, [{
    ...
    value: function updatedWidget(e) {
      ...
      (0, _api.updateWidget)(newEntry, id).then(function () {
        _this2.props.refreshList;
        _this2.props.getWidgets(_this2.props.renderWidgets);
      });
      //   .then(() => {
